...
public class DirectoryMonitorSource extends AbstractSource implements
		EventDrivenSource, Configurable {
	private static Logger LOG = LoggerFactory
			.getLogger(DirectoryMonitorSource.class);
	...
	public void configure(Context context) {
		...
		if (LOG.isDebugEnabled()) {
			for (Map.Entry<String, String> entry : context.getParameters()
					.entrySet()) {
